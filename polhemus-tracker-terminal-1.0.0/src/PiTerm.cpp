...
int main(int argc,char* argv[]){
  ...
  GtkWidget *scrWin,*vb1,*vb2,*vb3,*tb1,*hb2,*hb3,*hb4,*fr1,*fr2;
  GtkWidget *connect,*disconnect,*usb,*rs232,*capOn,*capOff,*lab1,*lab2,*cmd,*textview;
  GtkWidget* about,*close,*hb5,*clear;
  ...
  gtk_box_pack_start(GTK_BOX(vb1),connect,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(vb1),disconnect,FALSE,TRUE,0);
  ...
  gtk_table_attach_defaults(GTK_TABLE(tb1),usb,0,1,0,1);
  gtk_table_attach_defaults(GTK_TABLE(tb1),rs232,1,2,0,1);
  gtk_table_attach_defaults(GTK_TABLE(tb1),cnxStruct.portChooser,1,2,1,2);
  gtk_container_add(GTK_CONTAINER(fr1),tb1);
  ...
  hb2=gtk_hbox_new(TRUE,5);
  hb3=gtk_hbox_new(FALSE,5);
  ...
  gtk_box_pack_start(GTK_BOX(hb2),capOn,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(hb2),capOff,FALSE,TRUE,0);
  ...
  gtk_box_pack_start(GTK_BOX(hb3),cs.label,TRUE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(hb3),cs.browse,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(vb2),hb2,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(vb2),hb3,FALSE,TRUE,0);
  gtk_container_add(GTK_CONTAINER(fr2),vb2);
  ...
  hb4=gtk_hbox_new(FALSE,10);
  gtk_box_pack_start(GTK_BOX(hb4),vb1,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(hb4),fr1,TRUE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(hb4),fr2,TRUE,TRUE,0);
  ...
  hb5=gtk_hbox_new(FALSE,5);
  gtk_box_pack_end(GTK_BOX(hb5),close,FALSE,TRUE,0);
  gtk_box_pack_end(GTK_BOX(hb5),clear,FALSE,TRUE,0);
  gtk_box_pack_end(GTK_BOX(hb5),about,FALSE,TRUE,0);
  gtk_box_pack_start(GTK_BOX(hb5),GTK_WIDGET(cnxStruct.cnxLabel),FALSE,TRUE,0);
  ...
  gtk_box_pack_start(GTK_BOX(vb3),hb4,FALSE,TRUE,0);
  ...
  gtk_box_pack_start(GTK_BOX(vb3),hb5,FALSE,TRUE,0);

  gtk_container_add(GTK_CONTAINER(cs.win),vb3);
...
void OnAbout(GtkWidget* w,GtkWindow* win){
  ...
  const gchar* copyright="Polhemus Tracker Terminal Copyright © Polhemus 2009\nlibusb Copyright © 2007-2008 Daniel Drake and 2001 Johannes Erdfelt";

  gtk_show_about_dialog(win,"authors",author,"comments","Terminal Interface for Polhemus Trackers",
			"copyright",copyright,"version","1.0.0","program-name",
...
int QueryUser4TrackerType(int& trk){
  ...
  for (int i=1;i<NUM_SUPP_TRKS;i++){
    rb=gtk_radio_button_new_with_label_from_widget(GTK_RADIO_BUTTON(rb0),trackerNames[i]);
    gtk_box_pack_start(GTK_BOX(GTK_DIALOG(dlg)->vbox),rb,TRUE,TRUE,5);
...
void TrackerSelect(GtkToggleButton* button,int* pIndex){
  ...
  if (gtk_toggle_button_get_active(button))
    *pIndex=(int)g_object_get_data(G_OBJECT(button),"index");
